...
const SelectTrigger = React.forwardRef<  React.ElementRef<typeof SelectPrimitive.Trigger>,
  ...
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-slate-300 bg-transparent px-3 py-2 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:focus:ring-slate-800 dark:placeholder:text-slate-400",
      "transition-all duration-300 ease-in-out",
      "focus:border-accent dark:focus:border-accent focus:ring-4 focus:ring-accent/10 dark:focus:ring-accent/10",
      className
    )}
    {...props}
  >
