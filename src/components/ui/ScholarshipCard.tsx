...
export default function ScholarshipCard({ scholarship }: { scholarship: Scholarship }) {
    return (
        <Link href={`/scholarships/${scholarship.slug}`} className="flex">
            <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 flex flex-col w-full">
                ...
                <div className="p-6 flex-grow flex flex-col">
                    ...
                    <p className="text-gray-400 text-sm mb-4 flex-grow">{scholarship.description}</p>
