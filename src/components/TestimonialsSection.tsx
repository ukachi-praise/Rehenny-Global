    ...
    <section ref={sectionRef} id="testimonials" className="relative w-full min-h-[100vh] pb-24 overflow-visible font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <motion.h2
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6, ease: [0.16, 1, 0.3, 1] } } }}
            className="text-4xl md:text-5xl font-bold text-blue-600 mb-6 tracking-tight"
          >
            ...
            {TESTIMONIALS.map((t, index) => (
              ...
              >
                ...
                <div className="flex flex-col items-center text-center mt-2 h-full">
                  ...
                  <h4 className="text-gray-900 font-bold text-[15px] tracking-wide mb-1">{t.name}</h4>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-3 mb-3">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">{activeStudent.name}</h3>
            ...
            <div className="w-full lg:w-[320px] shrink-0 lg:border-l border-gray-100 lg:pl-8 flex flex-col gap-6 pt-6 lg:pt-0 border-t lg:border-t-0">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h5 className="text-gray-900 font-medium text-sm mb-0.5">Visa Approved</h5>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h5 className="text-gray-900 font-medium text-sm mb-0.5">Program</h5>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h5 className="text-gray-900 font-medium text-sm mb-0.5">Hometown</h5>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h5 className="text-gray-900 font-medium text-sm mb-0.5">Journey Duration</h5>
